...
?>
<aside id="studentSidebar" class="fixed inset-y-0 left-0 w-[240px] bg-white border-r border-[#e8ecf2] overflow-y-auto flex flex-col z-40 shadow-[2px_0_16px_rgba(15,42,83,0.06)] max-[960px]:-translate-x-full max-[768px]:hidden transition-transform duration-300">
...
<!-- Mobile Overlay -->
<div id="sidebarOverlay" class="fixed inset-0 bg-navy-950/50 z-30 hidden max-[768px]:!hidden" onclick="document.getElementById('studentSidebar').classList.add('max-[960px]:-translate-x-full');this.classList.add('hidden')"></div>
