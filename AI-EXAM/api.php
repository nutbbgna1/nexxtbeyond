...
function buildPrompt($qCount, $type, $difficulty, $details, $isPdf = false, $chunkText = "", $partIndex = 1, $totalParts = 1) {
    ...
    $prompt .= "7. เพิ่ม `imagePrompt` เป็นคำอธิบายภาพภาษาอังกฤษที่ละเอียด เมื่อภาพจำเป็นหรือช่วยให้เข้าใจโจทย์อย่างมีนัยสำคัญ หากไม่จำเป็นให้เป็นสตริงว่าง ภาพต้องไม่เปิดเผยคำตอบและไม่พึ่งข้อความในภาพ\n\n";
